	...
	public static $role_pages = array(
			'administrator' =>
						array(
							...
							'evoluciones' => array('list','view','add','edit', 'editfield','delete','list','view','add','edit', 'editfield','delete','editar','reporte'),
			...
			'user' =>
						array(
							...
							'evoluciones' => array('list','view','add','edit', 'editfield','delete','editar','reporte')
						),
