...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Editar información del tratamiento</h4>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row ">
                            ...
                            <ul class="nav  nav-tabs   ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " data-toggle="tab" href="#TabPage-1-Page2" role="tab" aria-selected="true">
                                        <i class="fa fa-bookmark "></i> PRESTACIONES
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    <div class=" reset-grids">
                                        <?php  
                                        $this->render_page("tratamientos/formeditar/$page_id"); 
                                        ?>
                                    </div>
                                </div>
                                <div class="tab-pane  fade" id="TabPage-1-Page2" role="tabpanel">
                                    <div class=" ">
                                        <?php  
                                        $this->render_page("detatratamiento/list/detatratamiento.tratamiento/$page_id?limit_count=20"); 
                                        ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6 comp-grid">
                    <div class=""><?php $_SESSION['codTratamiento']=$page_id;
                    ?></div>
                </div>
            </div>
        </div>
