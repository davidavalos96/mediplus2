                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    ...
                                    <div  class="bg-light p-3 animated fadeIn page-content">
                                        <form id="estrategiaterapeutica-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("estrategiaterapeutica/add?csrf_token=$csrf_token") ?>" method="post">
                                            <div>
                                                <div class="form-group ">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-modalidad" name="modalidad"  placeholder="Seleccione un valor"    class="custom-select" >
                                                                        ...
                                                                        $value = $option['value'];
                                                                        $label = $option['label'];
                                                                        $selected = $this->set_field_selected('modalidad', $value, "");
                                                                        ?>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-cantSemanas"  value="<?php  echo $this->set_field_value('cantSemanas',""); ?>" type="number" placeholder="Escribir  Cantsemanas" step="1"  required="" name="cantSemanas"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
