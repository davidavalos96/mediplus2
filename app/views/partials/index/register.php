...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="add"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Registro de usuario</h4>
                </div>
            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form id="usuarios-userregister-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("index/register?csrf_token=$csrf_token") ?>" method="post">
                            <!--[main-form-start]-->
                            <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-CLAVE"  value="<?php  echo $this->set_field_value('CLAVE',""); ?>" type="password" placeholder="Escribir  Clave"  required="" name="CLAVE"  class="form-control  password password-strength" />
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-profesional" name="profesional"  placeholder="Seleccione un valor"    class="custom-select" >
                                                                    <option value="">Seleccione un valor</option>
                                                                    <?php 
                                                                    $profesional_options = $comp_model -> usuarios_profesional_option_list();
                                                                    if(!empty($profesional_options)){
                                                                    foreach($profesional_options as $option){
                                                                    $value = (!empty($option['value']) ? $option['value'] : null);
                                                                    $label = (!empty($option['label']) ? $option['label'] : $value);
                                                                    $selected = $this->set_field_selected('profesional',$value, "");
                                                                    ?>
                                                                    <option <?php echo $selected; ?> value="<?php echo $value; ?>">
                                                                        <?php echo $label; ?>
                                                                    </option>
