                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-IDESPECIALIDAD">
                                        ...
                                        <td class="value"> <?php echo $data['IDESPECIALIDAD']; ?></td>
                                    </tr>
                                    <tr  class="td-PROFESIONAL">
                                        <th class="title"> Profesional: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-value="<?php echo $data['PROFESIONAL']; ?>" 
                                                data-pk="<?php echo $data['IDESPECIALIDAD'] ?>" 
                                                data-url="<?php print_link("especialidadesprofesional/editfield/" . urlencode($data['IDESPECIALIDAD'])); ?>" 
                                    ...
                                    <tr  class="td-ESPECIALIDAD">
                                        ...
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/especialidadesprofesional_ESPECIALIDAD_option_list'); ?>' 
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("especialidadesprofesional/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Editar
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("especialidadesprofesional/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal">
