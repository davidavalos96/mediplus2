                            ...
                            <ul class="nav  nav-tabs   ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " data-toggle="tab" href="#TabPage-1-Page2" role="tab" aria-selected="true">
                                        <i class="fa fa-list-alt "></i> ITEMS DE LA CONSULTA
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    <div class=" reset-grids">
                                        <?php  
                                        $this->render_page("tipo_evolucion/editar/$page_id"); 
                                        ?>
                                    </div>
                                </div>
                                <div class="tab-pane  fade" id="TabPage-1-Page2" role="tabpanel">
                                    <div class=" ">
                                        <?php  
                                        $this->render_page("item_evolucion/list/item_evolucion.evolucion/$page_id?orderby=item_evolucion.descripcion&ordertype=ASC&limit_count=20"); 
                                        ?>
                                    </div>
                                </div>
                            </div>
