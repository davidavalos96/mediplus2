    ...
    <div  class="">
        <div class="container">
            <div class="row bg-light p-3 mb-3">
                <div class="col ">
                    <h4 class="record-title">Listado de Prestaciones</h4>
                </div>
                <div class="col-sm-3 comp-grid">
                    <?php $modal_id = "modal-" . random_str(); ?>
                    <a href="<?php print_link("detatratamiento/add") ?>"  class="btn btn-primary open-page-modal">
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class=" animated fadeIn page-content">
                        <div id="detatratamiento-list-records">
                                ...
                                <table class="table  table-striped table-sm text-left">
                                    <thead class="table-header bg-light">
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <th class="td-sno">#</th>
                                            <th  class="td-especialidades_DESCRIPCION"> Prestación</th>
                                            <th  class="td-v_profesionales_NOMBAPEPRO"> Profesional</th>
                                            <th  class="td-honorarios"> (%) de Honorarios</th>
                                            <th class="td-btn"></th>
                                        </tr>
                                    </thead>
                                    <?php
                                    ...
                                    <div class="row justify-content-center">    
                                        <div class="col-md-auto justify-content-center">    
                                            <div class="p-3 d-flex justify-content-between">    
                                                <?php if($can_delete){ ?>
                                                <button data-prompt-msg="¿Está seguro de que desea eliminar estos registros?" data-display-style="modal" data-url="<?php print_link("detatratamiento/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
