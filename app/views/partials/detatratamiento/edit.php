            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("detatratamiento/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <input id="ctrl-tratamiento"  value="<?php  echo $data['tratamiento']; ?>" type="hidden" placeholder="Escribir  Tratamiento"  required="" name="tratamiento"  class="form-control " />
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-profesional" data-load-path="<?php print_link('api/json/detatratamiento_profesional_option_list') ?>" name="profesional"  placeholder="Seleccione un valor"    class="custom-select" >
                                                        ...
                                                        $profesional_options = $comp_model -> detatratamiento_profesional_option_list($data['prestacion']);
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-honorarios"  value="<?php  echo $data['honorarios']; ?>" type="number" placeholder="Escribir  Honorarios" step="1"  required="" name="honorarios"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
