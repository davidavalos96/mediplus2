        ...
        <div class="container-fluid">
            <div class="row ">
                ...
                <div class="col-sm-3 ">
                    ...
                    <a href="<?php print_link("evoluciones/add") ?>"  class="btn btn btn-primary my-1 open-page-modal">
                ...
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('evoluciones/'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('evoluciones'); ?>">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="evoluciones-lista-records">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-tipo_evolucion"> Tipo Evolucion</th>
                                                <th  class="td-profesional"> Profesional</th>
                                                <th  class="td-paciente"> Paciente</th>
                                                <th  class="td-tratamiento"> Tratamiento</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("evoluciones/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-fecha">
                                                        <span <?php if($can_edit){ ?> data-flatpickr="{ enableTime: false, minDate: '', maxDate: ''}" 
                                                            data-value="<?php echo $data['fecha']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("evoluciones/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="fecha" 
                                                    ...
                                                    <td class="td-tipo_evolucion">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/evoluciones_tipo_evolucion_option_list'); ?>' 
                                                            data-value="<?php echo $data['tipo_evolucion']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("evoluciones/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tipo_evolucion" 
                                                            ...
                                                            data-showbuttons="left" 
                                                            class="is-editable" <?php } ?>>
                                                            <?php echo $data['tipo_evolucion']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-profesional">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/evoluciones_profesional_option_list'); ?>' 
                                                            data-value="<?php echo $data['profesional']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("evoluciones/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-tratamiento">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/evoluciones_tratamiento_option_list'); ?>' 
                                                            data-value="<?php echo $data['tratamiento']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("evoluciones/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <th class="td-btn">
                                                        <?php if($can_view){ ?>
                                                        <a class="btn btn-sm btn-success has-tooltip" title="Ver registro" href="<?php print_link("evoluciones/view/$rec_id"); ?>">
                                                        ...
                                                        <?php } ?>
                                                        <?php if($can_delete){ ?>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Eliminar este registro" href="<?php print_link("evoluciones/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="¿Seguro que quieres borrar este registro?" data-display-style="modal">
