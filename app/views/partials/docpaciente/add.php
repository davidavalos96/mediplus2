                            ...
                            <ul class="nav  nav-tabs   ">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#TabPage-1-Page1" role="tab" aria-selected="true">
                                        <i class="fa fa-bars "></i> DATOS DEL DOCUMENTO
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    ...
                                    <div  class="bg-light p-3 animated fadeIn page-content">
                                        <form id="docpaciente-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("docpaciente/add?csrf_token=$csrf_token") ?>" method="post">
                                            <div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <select required=""  id="ctrl-TIPODOCUMENTO" name="TIPODOCUMENTO"  placeholder="Seleccione un valor"    class="custom-select" >
                                                                    ...
                                                                    <?php 
                                                                    $TIPODOCUMENTO_options = $comp_model -> docpaciente_TIPODOCUMENTO_option_list();
                                                ...
                                                <input id="ctrl-PACIENTE"  value="<?php echo $comp_model->docpaciente_PACIENTE_default_value() ?>" type="hidden" placeholder="Escribir  Paciente"  required="" name="PACIENTE"  class="form-control " />
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <div class="dropzone required" input="#ctrl-ARCHIVO" fieldname="ARCHIVO"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Vistazo" filesize="3" maximum="9999">
