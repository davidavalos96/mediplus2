                        ...
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-tipo_estudio">
                                        <th class="title"> Tipo Estudio: </th>
                                        <td class="value">
                                            <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/estudios_solicitados_tipo_estudio_option_list'); ?>' 
                                                data-value="<?php echo $data['tipo_estudio']; ?>" 
                                                data-pk="<?php echo $data['id'] ?>" 
                                                data-url="<?php print_link("estudios_solicitados/editfield/" . urlencode($data['id'])); ?>" 
                                                data-name="tipo_estudio" 
                                    ...
                                    <tr  class="td-tipo_estudio_id">
                                        <th class="title"> Tipo Estudio Id: </th>
                                        <td class="value"> <?php echo $data['tipo_estudio_id']; ?></td>
                                    </tr>
                                    <tr  class="td-tipo_estudio_descripcion">
                                        <th class="title"> Tipo Estudio Descripcion: </th>
                                        <td class="value"> <?php echo $data['tipo_estudio_descripcion']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
                                    ...
                                    <a class="dropdown-item export-link-btn" data-format="print" href="<?php print_link($export_print_link); ?>" target="_blank">
                                        ...
                                        <a class="dropdown-item export-link-btn" data-format="pdf" href="<?php print_link($export_pdf_link); ?>" target="_blank">
                                            ...
                                            <a class="dropdown-item export-link-btn" data-format="word" href="<?php print_link($export_word_link); ?>" target="_blank">
                                                ...
                                                <?php if($can_edit){ ?>
                                                <a class="btn btn-sm btn-info"  href="<?php print_link("estudios_solicitados/edit/$rec_id"); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                </a>
                                                <?php } ?>
                                                <?php if($can_delete){ ?>
                                                <a class="btn btn-sm btn-danger record-delete-btn mx-1"  href="<?php print_link("estudios_solicitados/delete/$rec_id/?csrf_token=$csrf_token"); ?>" data-prompt-msg="¿Esta seguro que quiere eliminar este registro ?" data-display-style="modal">
