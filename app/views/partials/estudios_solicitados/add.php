                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-1-Page1" role="tabpanel">
                                    ...
                                    <div  class="bg-light p-3 animated fadeIn page-content">
                                        <form id="estudios_solicitados-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="<?php print_link("estudios_solicitados/add?csrf_token=$csrf_token") ?>" method="post">
                                            <div>
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <select required=""  id="ctrl-tipo_estudio" name="tipo_estudio"  placeholder="Seleccione un valor"    class="custom-select" >
                                                                        ...
                                                                        $selected = $this->set_field_selected('tipo_estudio',$value, "");
                                                                        ?>
