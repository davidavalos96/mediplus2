            ...
            <div class="row ">
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("horarios_paciente/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-tratamiento"  value="<?php  echo $data['tratamiento']; ?>" type="number" placeholder="Escribir  Tratamiento" step="1"  required="" data-load-select-options="desde" name="tratamiento"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-desde" class="form-control datepicker  datepicker"  required="" value="<?php  echo $data['desde']; ?>" type="time" data-load-path="<?php print_link('api/json/horarios_paciente_desde_option_list') ?>" name="desde" placeholder="Escribir  Desde" data-enable-time="true" data-min-date="" data-max-date=""  data-alt-format="H:i" data-date-format="H:i:S" data-inline="false" data-no-calendar="true" data-mode="single" /> 
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-consultorio"  value="<?php  echo $data['consultorio']; ?>" type="number" placeholder="Escribir  Consultorio" step="1"  required="" name="consultorio"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-is_deleted"  value="<?php  echo $data['is_deleted']; ?>" type="text" placeholder="Escribir  Is Deleted"  required="" name="is_deleted"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
