                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-desde">
                                        ...
                                        <td class="value"> <?php echo $data['desde']; ?></td>
                                    </tr>
                                    <tr  class="td-hasta">
                                        <th class="title"> Hasta: </th>
                                        <td class="value"> <?php echo $data['hasta']; ?></td>
                                    </tr>
                                    <tr  class="td-cantSesiones">
                                        <th class="title"> Cantsesiones: </th>
                                        <td class="value"> <?php echo $data['cantSesiones']; ?></td>
                                    </tr>
                                    <tr  class="td-consultorio">
                                        <th class="title"> Consultorio: </th>
                                        <td class="value"> <?php echo $data['consultorio']; ?></td>
                                    </tr>
