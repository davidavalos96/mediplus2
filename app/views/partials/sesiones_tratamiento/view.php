                            ...
                            <ul class="nav  nav-tabs   ">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#TabPage-2-Page1" role="tab" aria-selected="true">
                                        <i class="fa fa-book "></i> DETALLE DE LAS SESIONES
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane show active fade" id="TabPage-2-Page1" role="tabpanel">
                                    <div class=" ">
                                        <?php  
                                        $this->render_page("sesiones_tratamiento/list/sesiones_tratamiento.tratamiento/$page_id?orderby=sesiones_tratamiento.dia&ordertype=ASC&limit_count=20"); 
                                        ?>
                                    </div>
                                </div>
                            </div>
