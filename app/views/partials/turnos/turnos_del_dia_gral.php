...
<section class="page ajax-page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Turnos del Dia</h4>
                </div>
                <div class="col-sm-3 ">
                </div>
                <div class="col-sm-4 ">
                ...
                <div class="row ">
                    <div class="col-md-12 comp-grid">
                        ...
                        <div  class=" animated fadeIn page-content">
                            <div id="turnos-turnos_del_dia_gral-records">
                                <div id="page-report-body" class="table-responsive">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                <th class="td-sno">#</th>
                                                <th style="width:7%;" class="td-HSTURNO"> Hora</th>
                                                <th style="width:28%;" class="td-v_paciente_NOMBAPEPAC"> Paciente</th>
                                                <th style="width:28%;" class="td-v_profesionales_NOMBAPEPRO"> Profesional</th>
                                                <th style="width:14%;" class="td-CANTSESIONES"> Cant Sesiones</th>
                                                <th style="width:14%;" class="td-ESTADOTURNO"> Estado del Turno</th>
                                                <th style="width:13%;" class="td-IDCONSULTORIO"> Consultorio</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
