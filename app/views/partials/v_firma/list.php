...
$can_add = ACL::is_allowed("v_firma/add");
$can_edit = ACL::is_allowed("v_firma/edit");
$can_view = ACL::is_allowed("v_firma/view");
$can_delete = ACL::is_allowed("v_firma/delete");
?>
<?php
...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">V Firma</h4>
                </div>
                <div class="col-sm-4 ">
                    <form  class="search" action="<?php print_link('v_firma'); ?>" method="get">
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-decoration-none" href="<?php print_link('v_firma'); ?>">
